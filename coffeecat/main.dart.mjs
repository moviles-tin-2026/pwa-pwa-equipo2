...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1325: x0 => ({maxAttempts: x0}),
      _1326: (x0,x1,x2) => globalThis.firebase_firestore.runTransaction(x0,x1,x2),
      ...
      _1384: (x0,x1) => x0.get(x1),
      _1386: (x0,x1,x2) => x0.set(x1,x2),
      ...
      _2011: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._2011(f,arguments.length,x0,x1) }),
      _2012: Date.now,
      ...
      _2157: () => Symbol("jsBoxedDartObjectProperty"),
      _2158: x0 => x0.random(),
